...
func ByteToMap(in []byte) (map[string]interface{}, error) {
...
func LookupString(name string, context ...interface{}) (string, bool) {
	v, ok := Lookup(name, context...)
	if !ok {
		return "", false
	}
...
func LookupInt(name string, context ...interface{}) (int64, bool) {
	v, ok := Lookup(name, context...)
	if !ok {
		return -1, false
	}
...
func LookupFloat(name string, context ...interface{}) (float64, bool) {
	v, ok := Lookup(name, context...)
	if !ok {
		return -1, false
	}
...
func LookupMap(name string, context ...interface{}) (map[string]interface{}, bool) {
	v, ok := Lookup(name, context...)
	if !ok {
		return nil, false
	}
