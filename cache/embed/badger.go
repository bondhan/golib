...
func init() {
	driver.Register(schema, NewBadgerCache)
}
...
func NewBadgerCache(url *url.URL) (driver.CacheDriver, error) {
...
func (b *BadgerCache) Delete(ctx context.Context, key string, opts ...driver.DeleteOptions) error {
	deleteCache := &driver.DeleteCache{}
...
func (b *BadgerCache) As(i interface{}) bool {
	p, ok := i.(**badger.DB)
	if !ok {
		return false
	}
