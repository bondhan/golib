module github.com/bondhan/golib/tracing

go 1.20

require (
	github.com/bondhan/golib/config v0.0.1
	github.com/bondhan/golib/log v0.0.5
...
require (
	...
	github.com/bondhan/golib/constant v0.0.1 // indirect
	...
	go.opentelemetry.io/otel/bridge/opencensus v0.26.0 // indirect
